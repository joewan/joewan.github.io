...
bcache[46]='<form action="http://search8.taobao.com/browse/search_auction.htm" name="f" accept-charset="gbk" method="get" onsubmit="s_gbk2utf();"><p><a href="http://www.taobao.com/go/chn/tbk_channel/onsale.php?pid=mm_19869273_2351859_9092254"><img border="0" src="http://www.5w.com/static/images/s/taobao.gif"></a><input type="text" id="b_kw" name="q" autocomplete="off" class="int" size="42"><input type="hidden" value="mm_19869273_2351859_9092254" name="pid"><input type="hidden" value="all" name="commend"><input type="hidden" value="action" name="search_type"><input type="submit" class="btn" id="bdbutton" value="淘宝搜索"></p></form>';
